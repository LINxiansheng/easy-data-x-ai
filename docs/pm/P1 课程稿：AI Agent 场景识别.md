...
[📺 点击观看 B站视频](https://www.bilibili.com/video/BV1uiDYBvEJ5)
...
我最早把 AI 应用到工作里的记录，是曾经在社区论坛里做过一个“论坛小助手”，用户在发帖时会默认 @ 这个小助手来回答问题。但上线后社区用户频繁抱怨“答非所问”。当时我以为是模型不行，要升级，于是就换到当时市面上最强的模型 GPT-4o。上线后，用户满意度几乎没有提升。
...
于是我把“论坛小助手”背后依赖的数据彻底整理了一遍：补全缺失的文档、修正过时的内容、统一了格式和标签。并设置官方文档更新后第一时间同步到 GitHub 仓库，作为小助手的知识库。

然后，我就可以非常放心地把论坛上的用户问题，全权交给小助手去处理了。这也是为什么我能忙里偷闲做这期课程，和大家分享我曾经犯下的错误。

我犯了什么错？不是技术选型错误，而是**问题诊断错误**。AI 做得不好，根本原因不在模型层——模型的理解能力已经足够了。问题在数据层：AI 需要查找的知识内容，要么不存在，要么过时了，要么格式混乱导致检索不到。

<!-- 这是一张图片，ocr 内容为：换模型? 3 1 整理数据! 2 答非所问 -->
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-01.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-02.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-03.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-04.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-05.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-06.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-07.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-08.png)
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/pm/P1/P1-09.png)
...
[【Exam】道篇（一）：AI Agent 场景识别](https://open.oceanbase.com/exam/760?junit=15756)
